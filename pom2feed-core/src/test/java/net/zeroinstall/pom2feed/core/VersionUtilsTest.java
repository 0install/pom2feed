...
public class VersionUtilsTest {
    ...
    public static Collection<Object[]> data() {
        return Arrays.asList(new Object[][]{
            ...
            {"1.0-xyz", "1.0-" + (120 * 128 * 128 + 121 * 128 + 122)},
            {"rc123", "1-rc123"},
            {"xyz", "1-" + (120 * 128 * 128 + 121 * 128 + 122)},
            {"xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx", "1-9223372036854775807"}
        });
    }
    ...
    public void testConvertToAsciiNumbers() {
        assertEquals(0, convertToAsciiNumbers(""));
        assertEquals(97 * 128 + 98, convertToAsciiNumbers("ab"));
    }
}